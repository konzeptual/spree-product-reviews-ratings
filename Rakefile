...
desc 'Generate documentation for the product_reviews_ratings extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ProductReviewsRatingsExtension'
...
desc 'Test the product_reviews_ratings extension.'
